NavLoader = module.exports =
  types:
    ...
    admin: [
      ...
      {std : 'Repos', id : 'view-repos', icon : null, cur : null, href : '/github/repos', token : null}
      {std : 'Starred Repos', id : 'view-starred', icon : null, cur : null, href : '/github/starred', token : null}
      {std : 'Logout', id : 'logout', icon : null, cur : null, href : '/logout', token : null}
    ]
